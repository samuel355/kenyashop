            ...
            <div class="col-lg-8 col-12 custom-padding-right">
                <div class="slider-head">
                    <div class="hero-slider">
                        <div class="single-slider" style="background-image: url(images/hero/h4.jpg);">
                            <div class="content">
                        ...
                        <div class="single-slider" style="background-image: url(images/hero/h2.jpg);">
                            <div class="content">
                                <h2><span>Big Sale Offer</span>
                                    Designer Men Shoe
                                </h2>
                        ...
                        <div class="single-slider" style="background-image: url(images/hero/h3.jpg);">
                            <div class="content">
                                <h2><span>Big Sale Offer</span>
                                    Designer Women Bag and shoe
                                </h2>
                        ...
                        <div class="single-slider" style="background-image: url(images/hero/h1.jpg);">
                            <div class="content">
                                <h2><span>Big Sale Offer</span>
                                    Designer Women Bag and shoe
                                </h2>
            ...
            <div class="col-lg-4 col-12">
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                        <div class="hero-small-banner" style="background-image: url('images/hero/h4.jpg');">
                            <div class="content">
                                <h2>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    ...
                    <p>There are many variations of products you can choose from. Explore below</p>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="single-banner" style="background-image:url('images/banner/b1.jpg')">
                    <div class="content">
                        <h2>Women Bag</h2>
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="single-banner custom-responsive-margin" style="background-image:url('images/banner/b4.jpg')">
                    <div class="content">
